        ...
        >
                ...
                >
                  <span className="hover-overlay mb-2 rounded d-block">
                    <img
                      ...
                      src="images/falcon-mode-default.jpg"
                    />
                  </span>
              ...
              <div className="col-6">
                ...
                >
                  <span className="hover-overlay mb-2 rounded d-block">
                    <img
                      className="img-fluid img-prototype mb-0"
                      src="images/falcon-mode-dark.jpg"
                    />
                  </span>
          ...
          <div className="d-flex justify-content-between">
            <div className="d-flex align-items-start">
              <img
                className="me-2"
                src="fonts/left-arrow-from-left.svg"
                width="20"
              />
          ...
          <div className="d-flex justify-content-between">
            <div className="d-flex align-items-start">
              <img className="me-2" src="fonts/arrows-h.svg" width="20" />
              <div className="flex-1">
          ...
          <hr />
          <div className="d-flex align-items-start">
            <img className="me-2" src="fonts/paragraph.svg" width="20" />
            <div className="flex-1">
          ...
          <div className="text-center mt-5">
            <img className="mb-4" src="images/47.png" width="120" />
