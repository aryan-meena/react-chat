    ...
    <>
      <div className="row g-3 mb-3">
        <div className="col-md-6 col-xxl-3">
          <Card extraClass="h-md-100 ecommerce-card-min-width">
            <CardHeader extraClass="pb-2 pt-2">
              <h6 className="mb-1 mt-1 d-flex align-items-center">
                Weekly Sales
                <span
            ...
            <CardBody extraClass="d-flex flex-column justify-content-end">
              <div className="row">
                <div className="col">
        ...
        <div className="col-md-6 col-xxl-3">
          <Card extraClass="  h-md-100">
            <CardHeader extraClass="pb-2 pt-2">
              <h6 className="mb-1 mt-1">Total Order</h6>
            </CardHeader>
            <CardBody extraClass="d-flex flex-column justify-content-end">
        ...
        <div className="col-md-6 col-xxl-3">
          <Card extraClass=" h-md-100">
            <CardHeader extraClass="pb-2 pt-2">
              <h6 className="mb-1 mt-1">Market Share</h6>
            </CardHeader>
            <CardBody>
        ...
        <div className="col-md-6 col-xxl-3">
          <Card extraClass=" h-md-100">
            <CardHeader extraClass="d-flex flex-between-center pb-2 pt-2">
              <h6 className="mb-1 mt-1">Weather</h6>
      ...
      <div className="row g-0">
        <div className="col-lg-6 pe-lg-2 mb-3">
          <Card extraClass=" h-lg-100 overflow-hidden">
            <CardHeader extraClass="pt-2 pb-2">
        ...
        <div className="col-lg-6 ps-lg-2 mb-3">
          <Card extraClass=" h-lg-100">
            ...
            <CardBody extraClass="h-100 pe-0">
              <div
      ...
      <div className="row g-0">
        <div className="col-lg-6 col-xl-7 col-xxl-8 mb-3 pe-lg-2 mb-3">
          <Card extraClass="h-lg-100">
            <CardBody extraClass="d-flex align-items-center">
              <div className="w-100">
                <h6 className="mb-3 text-800">
                  Using Storage
                  <strong className="text-dark">1775.06 MB </strong>of 2 GB
                </h6>
                <div
                        ...
                        <div className="d-flex align-items-center position-relative">
                          ...
                          <div className="flex-1 ms-3">
                            <h6 className="mb-1 fw-semi-bold">
                              <a className="text-dark stretched-link" href="#!">
                                Raven Pro
                              </a>
                            </h6>
            ...
            <div className="card-body pb-0">
              <div className="d-flex mb-3 hover-actions-trigger align-items-center">
                <div className="file-thumbnail">
                  <img
                    ...
                    src={require("../../assets/images/5-thumb.png")}
                  />
                </div>
                <div className="ms-3 flex-shrink-1 flex-grow-1">
                  ...
                  <div className="hover-actions end-0 top-50 translate-middle-y">
                    ...
                    >
                      <img
                        src={require("../../assets/fonts/cloud-download.svg")}
                        width="15"
                      />
                    </a>
                    <button
                    ...
                    >
                      <img
                        src={require("../../assets/fonts/edit-alt.svg")}
                        width="15"
                      />
                    </button>
                  </div>
              ...
              <div className="d-flex mb-3 hover-actions-trigger align-items-center">
                <div className="file-thumbnail">
                  <img
                    className="border h-100 w-100 fit-cover rounded-2"
                    src={require("../../assets/images/3-thumb.png")}
                  />
                </div>
                <div className="ms-3 flex-shrink-1 flex-grow-1">
                  <h6 className="mb-1">
              ...
              <div className="d-flex mb-3 hover-actions-trigger align-items-center">
                <div className="file-thumbnail">
                  <img
                    className="border h-100 w-100 fit-cover rounded-2"
                    src={require("../../assets/images/2-thumb.png")}
                  />
                </div>
                <div className="ms-3 flex-shrink-1 flex-grow-1">
                  <h6 className="mb-1">
      ...
      <div className="row g-0">
        <div className="col-sm-6 col-xxl-3 pe-sm-2 mb-3 mb-xxl-0">
          <Card extraClass="card">
            <CardHeader extraClass="d-flex flex-between-center py-2 pt-2 pb-2">
        ...
        <div className="col-sm-6 col-xxl-3 ps-sm-2 order-xxl-1 mb-3 mb-xxl-0">
          <Card extraClass=" h-100">
            <CardHeader extraClass="d-flex flex-between-center py-2">
            ...
            <CardBody extraClass="d-flex flex-center flex-column">
              <div
